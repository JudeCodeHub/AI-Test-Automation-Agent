  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-5 -right-6 hidden items-center gap-2 rounded-xl border border-(--landing-border) bg-(--landing-bg-raised) px-3 py-2 shadow-[0_12px_24px_-10px_rgba(0,0,0,0.15)] sm:flex"
      >
      ...
      <motion.div
        ...
        className="absolute -bottom-5 -left-6 hidden items-center gap-2 rounded-xl border border-(--landing-border) bg-(--landing-bg-raised) px-3 py-2 shadow-[0_12px_24px_-10px_rgba(0,0,0,0.15)] sm:flex"
      >
      ...
      >
        <div className="flex items-center justify-between border-b border-dashed border-(--landing-border) pb-3">
          <span className="font-mono text-xs tracking-wide text-(--landing-ink-muted)">
            RUN #4821
          </span>
