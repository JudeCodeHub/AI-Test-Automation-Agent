      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Settings2 className="text-primary" /> Project/Repo Settings
          </DialogTitle>
          <DialogDescription>
        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setRepoSettings({ ...repoSettings, globalInstructions: e?.target?.value })
              }
              placeholder="Instructions"
              className="mt-2"
            />
            <p className="mt-1 text-xs text-gray-600">
              Include any authentication credentials, cookies,setup or teardown instructions.they
              are automatically append to gemini prompts.
            </p>
          </div>
        </div>
        <DialogFooter>
