...
function TestCaseSettingDialog({ testCase, setReload }: props) {
  ...
  const [formTestCase, setFormTestCase] = useState({
    ...
    targetRoute: testCase?.targetDomain || '',
  ...
  const updateCase = async () => {
    const result = await axios.post('/api/test-cases/test-case-setting', {
      ...formTestCase,
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Modifying these parameters automattically clears pre-generated scripts to ensure synchornization
          </DialogDescription>
        </DialogHeader>
        ...
        <div>
          ...
          <div className='mt-5'>
            <label className='text-gray-500'>DESCRIPRION/ACTION</label>
            <Textarea
          ...
          <div className='mt-5'>
            <label className='text-gray-500'>EXPECTED RESULTS</label>
            <Textarea
