  ...
  return (
    <div className='mt-10 '>
      ...
      {repoList.map((repo, index) => (
        <Accordion type="single" collapsible defaultValue="item-1" key={index} className='mb-4'>
          <AccordionItem value="item-1" className='border rounded-xl overflow-hidden px-5'>
            <AccordionTrigger>
